...
static esp_err_t mpu9250_register_read(uint8_t reg_addr, uint8_t *data,
	size_t len)
    {
    return i2c_master_write_read_device(I2C_MASTER_NUM, MPU9250_SENSOR_ADDR,
	    &reg_addr, 1, data, len, I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
    }
...
static esp_err_t mpu9250_register_write_byte(uint8_t reg_addr, uint8_t data)
    ...
    ret = i2c_master_write_to_device(I2C_MASTER_NUM, MPU9250_SENSOR_ADDR,
...
static esp_err_t i2c_master_init(void)
    {
    int i2c_master_port1 = I2C_MASTER_NUM;
